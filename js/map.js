  ...
  const REGIONS_DATA = [
    {
      ...
      `,
      primaryBtnHtml: `<button class="btn btn-primary btn-full" onclick="window.openQuoteModal('London')">Get London Quote →</button>`,
      quoteRegion: "London"
    },
    {
      id: "berkshire",
    ...
    },
    {
      ...
      `,
      primaryBtnHtml: `<button class="btn btn-primary btn-full" onclick="window.openQuoteModal('South Coast')">Get South Coast Quote →</button>`,
    ...
    },
    {
      ...
      `,
      primaryBtnHtml: `<button class="btn btn-primary btn-full" onclick="window.openQuoteModal('Oxfordshire')">Get Oxfordshire Quote →</button>`,
    ...
    regionsList.forEach((region, idx) => {
      ...
      html += `
        <div class="regional-hub-card" data-region="${region.id}" style="${isClosest ? 'border-color: var(--amber-400); background: rgba(245,158,11,0.04);' : ''}">
          ...
          <div class="regional-hub-actions" style="margin-top:1.25rem;">
            ${userCoords
              ? `<button class="btn btn-primary btn-full" onclick="window.openQuoteModal('${region.quoteRegion}', '', '', '${userCoords.formatted}')">Get Quote from ${userCoords.formatted} →</button>`
